...
source=("${pkgname}64.exe::https://download.mikrotik.com/winbox/${pkgver}/${pkgname}64.exe"
        "${pkgname}.desktop"
        "${pkgname}.png"
        "${pkgname}")
...
package() {
  install -Dm755 "${srcdir}/${pkgname}64.exe" "${pkgdir}/usr/share/${pkgname}/${pkgname}.exe"
